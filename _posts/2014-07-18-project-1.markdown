...
This project has resulted in 2 papers, [one](https://arxiv.org/abs/2106.11371) detailing the *Model of Multiple CELLs* and [another](https://arxiv.org/abs/2110.08233v1) detailing the *Physarum Steiner Algorithm*. The first paper has been accepted to the *Journal of the Royal Society Interface* and the second paper has been submitted to *Nature Scientific Reports*. This project has been presented at the MIT PRIMES Conference, the UMS Poster Session, and has been accepted to the Joint Mathematics Meeting 2022. 
